#ifndef _SNIPERTURRET_H                 // Prevent multiple definitions if this 
#define _SNIPERTURRET_H                 // file is included in more than one place
#define WIN32_LEAN_AND_MEAN

#include "entity.h"
#include "constants.h"

namespace SniperTurretNS
{
    const int WIDTH = 64;                   // image width
    const int HEIGHT = 64;                  // image height
    const int X = GAME_WIDTH/2 - WIDTH/2;   // location on screenba
...
class SniperTurret : public Entity
{
private:
	int health;
	bool mouseActive;
